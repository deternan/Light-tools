...
public class Number_Special_str 
{
	...
	public Number_Special_str()
	{
		...
		{
			str_chat = String.valueOf(str_.charAt(i));
			if(str_chat.equalsIgnoreCase(tag)) {
				number_str ++;
			}
		}
	...
	{
		Number_Special_str num = new Number_Special_str();
	}
